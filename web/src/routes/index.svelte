      ...
      <div class="flex flex-col rounded-lg shadow-lg dark:shadow-slate-400 dark:shadow-sm overflow-hidden">
        <div class="flex-shrink-0">
          <a href="https://bleeps.art" target="_blank"
            ><img class="h-48 w-full object-cover" src={`${base}/images/bleeps-preview.png`} alt="bleeps.art" /></a
          >
        </div>
      ...
      <div class="flex flex-col rounded-lg shadow-lg dark:shadow-slate-400 dark:shadow-sm overflow-hidden">
        <div class="flex-shrink-0">
          <a href="https://mandalas.eth.limo" target="_blank"
            ><img class="h-48 w-full object-cover" src={`${base}/images/mandalas-preview.png`} alt="mandalas.eth" /></a
          >
        </div>
        <div class="flex-1 bg-white dark:bg-black p-6 flex flex-col justify-between">
          <div class="flex-1">
      ...
      <div class="flex flex-col rounded-lg shadow-lg dark:shadow-slate-400 dark:shadow-sm overflow-hidden">
        <div class="flex-shrink-0">
          <a href="https://conquest.eth.limo" target="_blank"
            ><img class="h-48 w-full object-cover" src={`${base}/images/conquest-preview.png`} alt="conquest.eth" /></a
          >
        </div>
        <div class="flex-1 bg-white dark:bg-black p-6 flex flex-col justify-between">
          <div class="flex-1">
            ...
            <div class="block mt-2">
              ...
              <p class="mt-3 text-base text-gray-700 dark:text-gray-300">
                ...
                through on-chain alliances while remaining sovereign. A first of its kind. >>>>>>> dev
              </p>
...
<footer class="bg-white dark:bg-black">
  <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
    <div class="flex justify-center space-x-6 md:order-2">
      ...
      <a href="https://ronan.eth.limo" class="text-gray-400 hover:text-gray-500">
    ...
    <div class="mt-8 md:mt-0 md:order-1">
      <p class="text-center text-base leading-6 text-gray-400">Created by Ronan Sandford.</p>
    </div>
  </div>
</footer>
